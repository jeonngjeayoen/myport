$(function () {
    ...
    setTimeout(function () {
        $('.tab01').addClass('a-top');
    }, 3000);

    setTimeout(function () {
        $('.tab02').addClass('b-top');
    }, 3200);

    setTimeout(function () {
        $('.tab03').addClass('b-top');
    }, 3400);
    $('.tab01 p').addClass('on');
    // 첫번째 번개
    ...
    $('.img_box')
        .delay(2000)
        .animate({ width: '100%', height: '10px' }, 500, function () {
            $('.jupiter_art01').addClass('b-width');
            $('.img_box img').removeClass('on');
        })
        .animate({ height: '485px', top: '0px' }, 500);
    //폰
    $('.phone_img')
        .delay(2000)
        .animate({ width: '86%', height: '5px' }, 500, function () {
            $('.phone_img img').removeClass('on');
        })
        .animate({ height: '85%', top: '49%' }, 500);
    //탭버튼 첫번째
    $('.tab01').click(function () {
        ...
        $('.tab01').addClass('a-top');
        $('.tab02').addClass('b-top').removeClass('a-top');
        $('.tab03').addClass('b-top').removeClass('a-top');
        //다른버튼
        $('.img_box2')
            .animate({ height: '0px', top: '250px' }, 500, function () {
                $('.jupiter_art02').addClass('width').removeClass('b-width');
                $('.img_box2 img').addClass('on');
            })
            .animate({ width: '0px', height: '0px' }, 500);
        $('.img_box3')
            .animate({ height: '0px', top: '250px' }, 500, function () {
                $('.jupiter_art03').addClass('width').removeClass('b-width');
                $('.img_box3 img').addClass('on');
            })
            .animate({ width: '0px', height: '0px' }, 500);
        // 다른 폰
        $('.phone_img2')
            .animate({ height: '5px' }, 500, function () {
    ...
    $('.tab02').click(function () {
        ...
        $('.tab03 p').removeClass('on');
        $('.tab01').addClass('b-top').removeClass('a-top');
        $('.tab02').addClass('a-top');
        $('.tab03').addClass('b-top').removeClass('a-top');
        //다른버튼
        $('.img_box')
            .animate({ height: '0px', top: '250px' }, 500, function () {
                $('.jupiter_art01').addClass('width').removeClass('b-width');
                $('.img_box img').addClass('on');
            })
            .animate({ width: '0px', height: '0px' }, 500);
        $('.img_box3')
        ...
        $('.img_box2')
            .delay(800)
            .animate({ width: '100%', height: '10px' }, 500, function () {
                $('.jupiter_art02').addClass('b-width');
    ...
    $('.tab03').click(function () {
        ...
        $('.img_box3')
            .delay(800)
            .animate({ width: '100%', height: '10px' }, 500, function () {
                $('.jupiter_art03').addClass('b-width');
    ...
    $('.img_box').click(function () {
        $('.j_ball1')
            .animate({ opacity: '1', 'z-index': '999999' }, 100)
            .animate({ 'border-radius': '50%' }, 100)
            .animate({ width: '1px' }, 100)
            .animate({ height: '1px' }, 200, function () {
                $('.j_ball1').animate(
                    {
                        width: '3000px',
                        height: '3000px',
